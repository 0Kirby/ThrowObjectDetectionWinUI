...
namespace ThrowObjectDetection
{
    ...
    /// </summary>
    public sealed partial class AnnotatePage3 : Page
    {
        public AnnotatePage3()
        {
        ...
        {
            MainPage.Current.NavView_SubPage_Navigate("ThrowObjectDetection.AnnotatePage4", new Microsoft.UI.Xaml.Media.Animation.EntranceNavigationTransitionInfo());
        }
